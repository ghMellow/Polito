...
// timer 0 e 1 sono già accesi, 2 e 3 no! |
...
// farlo ripartire da zero senza però pulire il primo bit
void reset_timer( uint8_t timer_num )
{
  ...
  if ( timer_num == 0 )
  {
 regVal = ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TCR; // prende val del timer 0 e metto in registro
 regVal |= 0x02; // bit wise con 2 (binario: 10) e così mette a 1 il 2 bit di reset e 0 che indica che non devono essere toccati
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TCR = regVal; // sovrascire valore registro
  }
  else if (timer_num==1)
  {
...
uint32_t init_timer ( uint8_t timer_num, uint32_t Prescaler, uint8_t MatchReg, uint8_t SRImatchReg, uint32_t TimerInterval )
{
  ...
  if(MatchReg == 0) {
   ...
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MCR |= SRImatchReg << (3*MatchReg); //bit wise OR così da usare in contemporanea tutti i match register senza pulire il registro
  } else if (MatchReg == 1) {
 ...
 // timer 1
  ...
  if(MatchReg == 0) {
   ...
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->MCR |= SRImatchReg << (3*MatchReg); //bit wise OR così da usare in contemporanea tutti i match register senza pulire il registro
  } else if (MatchReg == 1) {
 ...
 // timer 2
  ...
  if(MatchReg == 0) {
   ...
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->MCR |= SRImatchReg << (3*MatchReg); //bit wise OR così da usare in contemporanea tutti i match register senza pulire il registro
  } else if (MatchReg == 1) {
 ...
 // timer 3
  ...
  if(MatchReg == 0) {
   ...
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->MCR |= SRImatchReg << (3*MatchReg); //bit wise OR così da usare in contemporanea tutti i match register senza pulire il registro
  } else if (MatchReg == 1) {
